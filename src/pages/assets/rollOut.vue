<template>
  <div>
    ...
    <div>
      <p class="balance">钱包余额:6489.54 HKDT</p>
      <div class="xc-cell">
        <div class="cell-wrapper">
          <div class="content-left">
            <p class="title">地址</p>
            <p class="desc">
              <input class="xc-input" type="text" placeholder="请输入收款地址" />
            </p>
          </div>
        </div>
      ...
      <div class="xc-cell">
        <div class="cell-wrapper">
          <div class="content-left">
            <p class="title">金额</p>
            <p class="desc">
              <input class="xc-input" type="text" placeholder="请输入转账金额" />
            </p>
          </div>
        </div>
      </div>
      <p class="balance">手续费：7.38HDK</p>
      <div class="submit">
        <p class="btn">
          <mt-button>确认转出</mt-button>
        </p>
      </div>
    </div>
  </div>
